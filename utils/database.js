...
module.exports.updateEverything = function checkHumanity(username, param1, param2, param3,param4) {
  return database.query(
    `UPDATE userdata SET orderAmount = orderAmount + 1, momEnergy = momEnergy + $2, directorEnergy = directorEnergy + $3, domEnergy = domEnergy + + $4, gayEnergy = gayEnergy + $5 WHERE username=$1 RETURNING *`,
